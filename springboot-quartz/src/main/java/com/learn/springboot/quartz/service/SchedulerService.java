package com.learn.springboot.quartz.service;
...
public class SchedulerService {
    ...
    public void scheduleJobOrTrigger(SchedulerEntity schedulerEntity) throws SchedulerException, ClassNotFoundException {
        ...
        if (!StringUtils.isEmpty(job_class_name)) {
        ...
        if (jobDetail == null && !StringUtils.isEmpty(job_group) && !StringUtils.isEmpty(job_name)) {
        ...
        if (jobDetail != null && !StringUtils.isEmpty(cron_expression)) {
    ...
    private Trigger getTrigger(SchedulerEntity schedulerEntity, JobKey jobKey) {
        ...
        if (StringUtils.isEmpty(schedulerEntity.getTrigger_name())) {
    ...
    private JobDetail getJobDetail(SchedulerEntity schedulerEntity) throws ClassNotFoundException {
        ...
        if (StringUtils.isEmpty(schedulerEntity.getJob_name())) {
